...
DELETE /student/deleteStudent/{studentId}: Delete a student by ID (requires Librarian access)
GET /student/getAllStudents: Get a list of all students (requires Librarian access)
...
GET /book/getAllBooks: Get a list of all books (requires Librarian access)
GET /book/getBookById/{bookId}: Get a book by ID (requires Librarian access)
DELETE /book/deleteBook/{bookId}: Delete a book by ID (requires Librarian access)
